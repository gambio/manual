...
|UVP bei Sonderangebotspreisen anzeigen|Ist der Haken gesetzt, wird bei Sonderangeboten der ursprüngliche Artikelpreis mit dem Zusatz _**UVP**_ angezeigt. Der Zusatz kann bei Bedarf unter _**Toolbox \> Texte anpassen**_ bzw. _**Inhalte \> Texte anpassen**_ geändert werden.|
