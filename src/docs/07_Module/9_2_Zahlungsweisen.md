...
### Installieren und Einrichten von Modulen {#zahlungsweisen_gambio_payment_hub_installieren_und_einrichten_von_modulen}
...
1. Logge dich im Gambio Admin deines Shops ein.
...
#### Ersteinrichtung {#zahlungsweisen_gambio_payment_hub_paypal2hub_ersteinrichtung}
...
![](../Bilder/2022-02-15_004.png "Angabe der E-Mail-Adresse")


![](../Bilder/2022-02-15_005.png "Einloggen bei PayPal")
...
![](../Bilder/2022-02-15_006.png "Schaltfläche Zustimmen und verbinden am Ende der Seite")
...
![](../Bilder/2022-02-15_008.png "Angabe von Unternehmensinformationen")
![](../Bilder/2022-02-15_009.png)
![](../Bilder/2022-02-15_010_.png)
![](../Bilder/2022-02-15_011.png)
...
![](../Bilder/PayPal2Hub/2022-03-09_004.png "Eingabemaske beim Bearbeiten des Moduls")
...
![](../Bilder/PayPal2Hub/2022-03-09_003.png "Banner-Einstellungen für das Modul PayPal2Hub")
...
![](../Bilder/PayPal2Hub/2022-03-09_006.png "Eingabemaske für den Expertenmodus")
...
#### Darstellung im Bestellvorgang {#zahlungsweisen_gambio_payment_hub_paypal2hub_darstellung_im_bestellvorgang}
...
![](../Bilder/2022-02-16_003.png "Block _**Kontoverbindung für Zahlung**_")
...
![](../Bilder/2022-02-16_002.png "Erstattung im Block _**PayPal2Hub (API v2)**_")
...
### Gambio secured Payments - powered by Klarna {#zahlungsweisen_gambio_payment_hub_klarnahub}
...
##### Rechnungsstellung {#zahlungsweisen_gambio_payment_hub_klarnahub_abwicklung_der_bestellung_rechnungsstellung}
...
### easyCredit {#zahlungsweisen_gambio_payment_hub_easycredithub}
...
##### Summenblock mit Zinsen für die Ratenzahlung {#zahlungsweisen_gambio_payment_hub_easycredithub_ablauf_im_bestellvorgang_summenblock}
...
###### Sonstige Einstellungen {#zahlungsweisen_sonstige_paypal3_konfiguration_experteneinstellungen_sonstige_einstellungen}

![](../Bilder/pp3_2022_02_03_002.png "Experteneinstellungen _**Sonstige Einstellungen**_")
...
###### Entwicklertools {#zahlungsweisen_sonstige_paypal3_konfiguration_experteneinstellungen_entwicklertools}
...
###### Automatische Statusaktualisierungen von Zahlungen \(PayPal-Parameter\) {#zahlungsweisen_sonstige_paypal3_konfiguration_experteneinstellungen_automatische_statusaktualisierungen_von_zahlungen}
...
###### Darstellung auf der PayPal Zahlungsseite \(PayPal-Parameter\) {#zahlungsweisen_sonstige_paypal3_konfiguration_experteneinstellungen_darstellung_auf_der_paypal_zahlungsseite}
...
### Bezahlen über Amazon \(amazonadvpay\) {#zahlungsweisen_sonstige_bezahlen_ueber_amazon}
...
#### Installation {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_installation}
...
##### Bearbeitung {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_installation_bearbeitung}
...
#### Konfiguration {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_konfiguration}
...
##### Zugangsdaten {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_konfiguration_zugangsdaten}
...
##### Erscheinungsbild {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_konfiguration_erscheinungsbild}
...
##### Einstellungen {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_konfiguration_einstellungen}
...
##### Standard-Bestellstatūs verwenden {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_konfiguration_standard_bestellstatus_verwenden}
...
##### Verbindung prüfen {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_konfiguration_verbindung_pruefen}
...
#### Darstellung im Bestellvorgang {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_darstellung_im_bestellvorgang}
...
##### Warenkorb {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_darstellung_im_bestellvorgang_warenkorb}
...
##### Versandartenauswahl {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_darstellung_im_bestellvorgang_versandartenauswahl}
...
##### Zahlungsweisenauswahl {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_darstellung_im_bestellvorgang_zahlungsweisenauswahl}
...
##### Zusammenfassung {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_darstellung_im_bestellvorgang_zusammenfassung}
...
#### Behandlung der Bestellungen {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_behandlung_der_bestellungen}
...
##### Daten aktualisieren {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_behandlung_der_bestellungen_daten_aktualisieren}
...
##### Vorgang abschließen {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_behandlung_der_bestellungen_vorgang_abschliessen}
...
##### Zahlung autorisieren {#zahlungsweisen_sonstige_bezahlen_ueber_amazon_behandlung_der_bestellungen_zahlung_autorisieren}

Die Zahlung wird normalerweise automatisch autorisiert, dies muss nur in Ausnahmefällen manuell erfolgen.


### Payone {#zahlungsweisen_sonstige_payone}
...
#### Installation {#zahlungsweisen_sonstige_payone_installation}
...
#### Konfiguration {#zahlungsweisen_sonstige_payone_konfiguration}

##### Konfiguration der Bestellstatus {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_bestellstatus}

Hier können die Bestellstatus konfiguriert werden.

##### Globale Parameter {#zahlungsweisen_sonstige_payone_konfiguration_globale_parameter}
...
##### Adressprüfung {#zahlungsweisen_sonstige_payone_konfiguration_adresspruefung}
...
##### Bonitätsprüfung {#zahlungsweisen_sonstige_payone_konfiguration_bonitaetspruefung}
...
##### Konfiguration der Zahlungsarten {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_zahlungsarten}
...
###### Kreditkarten \(paymentgenre\_creditcard\) {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_zahlungsarten_paymentgenre_creditcard}
...
###### Online-Überweisungen \(paymentgenre\_onlinetransfer\) {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_zahlungsarten_paymentgenre_onlinetransfer}
...
###### e-Wallet \(paymentgenre\_ewallet\) {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_zahlungsarten_paymentgenre_ewallet}
...
###### Kontobasierte Zahlungsweisen \(paymentgenre\_accountbased\) {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_zahlungsarten_paymentgenre_accountbased}
...
###### Finanzierung/Ratenkauf \(paymentgenre\_installment\) {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_zahlungsarten_paymentgenre_installments}
...
###### Rechnung/Refactoring \(paymentgenre\_safeinv\) {#zahlungsweisen_sonstige_payone_konfiguration_konfiguration_der_zahlungsarten_paymentgener_safeinv}
...
##### Zahlungsart hinzufügen {#zahlungsweisen_sonstige_payone_konfiguration_zahlungsart_hinzufuegen}
...
#### Konfiguration exportieren {#zahlungsweisen_sonstige_payone_konfiguration_exportieren}
...
#### Payone API Log {#zahlungsweisen_sonstige_payone_payone_api_log}
...
#### TransactionStatus-URL {#zahlungsweisen_sonstige_payone_transactionstatus_url}
...
### iPayment {#zahlungsweisen_sonstige_ipayment}
...
#### Installation {#zahlungsweisen_sonstige_ipayment_installation}
...
#### Konfiguration {#zahlungsweisen_sonstige_ipayment_konfiguration}
...
### Heidelpay {#zahlungsweisen_sonstige_heidelpay}
...
#### Installation {#zahlungsweisen_sonstige_heidelpay_installation}
...
#### Konfiguration der Sandbox {#zahlungsweisen_sonstige_heidelpay_konfiguration_der_sandbox}
...
#### Einrichtung eines Zahlungsmoduls in der Sandbox {#zahlungsweisen_sonstige_heideplay_einrichtung_eines_zahlungsmoduls_in_der_sandbox}
